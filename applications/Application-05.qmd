...
Mabel says: “I’ve been learning to use the Force! (Like in Star Wars.) If you roll a fair four-sided die, I can use the Force to make it land on a 1Links to an external site.! I’m still learning, so I can’t do it every time, but it definitely works sometimes!”
...
4. Now consider a Bayesian analysis for Mabel. Which one of the following prior distributions for represents the most prior skepticism about Mabel’s claim? Choose one and explain your reasoning.
