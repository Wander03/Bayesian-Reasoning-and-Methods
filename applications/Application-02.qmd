...
1. Plot the posterior distribution after day 1 in a tile plot like the one for the prior.

1. Compare the posterior distribution to the prior; how has it changed?

1. Which location will you search on day 2?
...
1. Plot the posterior distribution after day 2 in a tile plot like the one for the prior.

1. Compare the posterior distribution after day 2 to the posterior distribution after day 1; how has it changed?

1. Which location will you search on day 3?
